    ...
    <div class="playmusic__control">
      <div class="icon__container">
        ...
        <svg
          ...
          class="svg-inline--fa fa-circle-pause"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          type="rounded"
